...
def _convert_dict_to_message(_dict: Mapping[str, Any]) -> BaseMessage:
    ...
    if role == "assistant":
        ...
        elif reasoning_content := _dict.get("reasoning"):
            additional_kwargs["reasoning_content"] = reasoning_content
...
class ChatOpenAICompatible(BaseChatOpenAI):  # type: ignore[override]
...
# Backwards-compat alias for internal references in docstrings/examples.
